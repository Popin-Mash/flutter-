...
import 'package:ux_ui/models/jewwllery_model.dart';
import 'package:ux_ui/repository/constant_repository.dart';

class TabBarSwitching extends StatefulWidget {
  const TabBarSwitching({super.key});

  @override
  State<TabBarSwitching> createState() => _TabBarSwitchingState();
}

class _TabBarSwitchingState extends State<TabBarSwitching> {
  /// Categories keys
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  _buildItemList(JewelleryRepository.earn),
  ...
  /// Item Lists
  Widget _buildItemList(List<Jewellery> categories) {
    return Column(
  ...
  Widget _buildSingleItem(Jewellery item) {
    return Column(
      children: [
        SizedBox(
